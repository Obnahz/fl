...
import { getDungeonHighestFloorKey } from '../src/plugins/dungeon.js'
...
test('dungeon highest-floor progress uses the selected difficulty bucket', () => {
  ...
  assert.equal(getDungeonHighestFloorKey(5), 'dungeonHighestFloor_5')
  assert.equal(getDungeonHighestFloorKey(10), 'dungeonHighestFloor_10')
  assert.equal(getDungeonHighestFloorKey(100), 'dungeonHighestFloor_100')
})

...
<style scoped>
  ...
  .gacha-item-container {
    ...
    border-radius: 6px;
    background: color-mix(in srgb, var(--jade-pale) 30%, var(--surface));
    display: flex;
  ...
  .filter-section {
    padding: 16px;
    margin-bottom: 16px;
    background-color: color-mix(in srgb, var(--jade-pale) 24%, var(--surface));
    border-radius: 6px;
    border: 1px solid var(--line);
  }
  ...
  .result-item {
    background: color-mix(in srgb, var(--surface) 90%, var(--jade-pale));
  ...
  .wishlist-info {
    margin-top: 16px;
    padding: 12px;
    background-color: color-mix(in srgb, var(--jade-pale) 26%, var(--surface));
    border: 1px solid var(--line);
    border-radius: 4px;
  }
  ...
  .wish-bonus::before {
    ...
    color: var(--gold);
    font-size: 20px;
    text-shadow: 0 0 5px rgba(197, 161, 93, 0.55);
